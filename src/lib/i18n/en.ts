...
export const EN: Record<string, string> = {
  ...
  "Avancé": "Advanced",
  "Poids": "Weight",
  "Aucune tâche rattachée.": "No task attached.",
  "faite": "done",
  "à faire": "to do",
  ...
  "récurrente, non comptée": "recurring, not counted",
  ...
  "Saisis le nombre à atteindre : l’étape commence à compter dès qu’il existe.": "Enter the number to reach: the step starts counting as soon as it exists.",
  ...
  "Rattacher une tâche, ou en créer une…": "Attach a task, or create one…",
  "Rattacher une tâche à « {titre} »": "Attach a task to “{titre}”",
  ...
  "Poids {p} : cette étape compte {p} fois plus qu’une étape de poids 1 dans « {titre} ».": "Weight {p}: this step counts {p} times more than a weight-1 step in “{titre}”.",
  "{n} étape": "{n} step",
  "{n} étapes": "{n} steps",
